...
import '../widgets/additioanl_info_item.dart';
      ...
      body: BlocBuilder<WeatherBloc,WeatherState>(
        builder: (context, state) {
         ...
         if(state is! WeatherSuccess){
          ...
          final data = state.weatherModelList[0];
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child:
                  ListView.builder(
                    itemCount: 20,//tate.weatherModelList.length,
                    scrollDirection: Axis.horizontal,
                    itemBuilder: (context, index) {
                      final hourlyForecast = state.weatherModelList[index + 1];
                      final hourlySky =
                      state.weatherModelList[index + 1].currentSky;
                      final hourlyTemp =
                      hourlyForecast.currentTemp;
